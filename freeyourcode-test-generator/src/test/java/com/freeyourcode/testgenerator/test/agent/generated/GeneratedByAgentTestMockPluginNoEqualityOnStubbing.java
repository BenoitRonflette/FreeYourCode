...
public class GeneratedByAgentTestMockPluginNoEqualityOnStubbing extends GeneratedTestCase {
	...
	@Test
	public void testmethodReturning0AfterComputing_3() throws Exception {
		//Mock the stub methods
		Object[] getItself_diffsOnExit_0 = new Object[]{null};
		Object[] getItself_diffsOnExit_1 = new Object[]{null};
		Object[] getItself_diffsOnExit_2 = new Object[]{null};
		Object response0 = JsonSerialisationUtils.deserialize("{\"@type\":\"int\",\"value\":2}");
		Object response1 = JsonSerialisationUtils.deserialize("{\"@type\":\"int\",\"value\":4}");
		Object response2 = JsonSerialisationUtils.deserialize("{\"@type\":\"int\",\"value\":2}");
